    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="py-12 md:py-16">
        <div className="mb-12 text-center md:text-left">
          <h1 className="text-4xl md:text-5xl font-playfair font-bold mb-4">Galeria Institucional</h1>
          <p className="text-muted-foreground text-lg max-w-2xl">
            Uma janela visual para as nossas atividades, eventos e o cotidiano da nossa organização.
          </p>
        </div>
